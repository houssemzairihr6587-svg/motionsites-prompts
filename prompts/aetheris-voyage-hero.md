...
`````nBuild Prompt: Cinematic Space-Travel Landing Page
...
font-heading â†’ 'Instrument Serif', serif (always italic in use)
font-body â†’ 'Barlow', sans-serif
Default border radius override: DEFAULT: "9999px" (so bare rounded â†’ pill).

Liquid-glass utilities (exact CSS, in a <style> block)
Two variants â€” .liquid-glass (subtle, for nav/chips/cards) and .liquid-glass-strong (heavier blur, for primary CTA):
...
Section 1 â€” Hero (full viewport, black bg)
Background video (120% width/height, top-aligned, centered horizontally â€” focal point is the top of frame):

src: https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260418_080021_d598092b-c4c2-4e53-8e46-94cf9064cd50.mp4
class: absolute left-1/2 top-0 -translate-x-1/2 object-cover object-top z-0
style: { width: "120%", height: "120%" }
No overlay. z-10 layer holds: Navbar â†’ Hero content (flex-1, centered) â†’ Partners.

Navbar (fixed top-4, px-8 / lg:px-16, z-50)
Left: 48Ã—48 liquid-glass circle with italic serif lowercase "a" (Instrument Serif).
Center (desktop only): liquid-glass pill, px-1.5 py-1.5, holding 5 text links â€” Home, Voyages, Worlds, Innovation, Plan Launch â€” each px-3 py-2 text-sm font-medium text-white/90 font-body. Followed by a white pill button Claim a Spot + ArrowUpRight icon (bg-white text-black, whitespace-nowrap).
Right: 48Ã—48 invisible spacer to balance logo.
...
Headline â€” BlurText component (word-by-word animation, see below). Text: "Venture Past Our Sky Across the Universe". Classes: text-6xl md:text-7xl lg:text-[5.5rem] font-heading italic text-white leading-[0.8] max-w-2xl justify-center tracking-[-4px].
Subheading (delay 0.8s, mt-4 text-sm md:text-base text-white max-w-2xl font-body font-light leading-tight): "Discover the universe in ways once unimaginable. Our pioneering vessels and breakthrough engineering bring deep-space exploration within reachâ€”secure and extraordinary."
...
Top: white 28Ã—28 outline SVG icon (clock for card 1, globe for card 2).
...
Row of 5 names in Instrument Serif italic white, text-2xl md:text-3xl tracking-tight, gap-12/md:gap-16: Aeon Â· Vela Â· Apex Â· Orbit Â· Zeno.
...
3-step keyframes to {filter: 'blur(5px)', opacity: 0.5, y: -5} â†’ {filter: 'blur(0px)', opacity: 1, y: 0}
duration: 0.7 (stepDuration 0.35 Ã— 2), times: [0, 0.5, 1], ease: easeOut
Stagger: delay = (i * 100) / 1000 seconds
display: inline-block, marginRight: 0.28em (not non-breaking-space â€” letter-spacing -4px eats nbsp).
Parent <p> is display: flex; flexWrap: wrap; justifyContent: center; rowGap: 0.1em.
Section 2 â€” Capabilities (min-h-screen, black bg)
...
Kicker: text-sm font-body text-white/80 mb-6 â†’ // Capabilities
...
Left: 44Ã—44 nested liquid-glass square (rounded-[0.75rem]) with a white Material Icons SVG (fill currentColor, h-6 w-6 text-white). Use random Material icons â€” these three used:
AI Scenery: image icon â€” path M5 21q-.825 0-1.412-.587T3 19V5q0-.825.588-1.412T5 3h14q.825 0 1.413.588T21 5v14q0 .825-.587 1.413T19 21H5Zm1-4h12l-3.75-5-3 4L9 13l-3 4Z
Batch Production: movie icon â€” path M4 6.47 5.76 10H20v8H4V6.47M22 4h-4l2 4h-3l-2-4h-2l2 4h-3l-2-4H8l2 4H7L5 4H4c-1.1 0-1.99.89-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4Z
Smart Lighting: lightbulb icon â€” path M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1Zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.86-3.14-7-7-7Z
Right: flex flex-wrap justify-end gap-1.5 max-w-[70%] â€” 4 small liquid-glass pill tags (rounded-full px-3 py-1 text-[11px] text-white/90 font-body whitespace-nowrap):
Card 1: Natural Context Â· Photo Realism Â· Infinite Settings Â· Eco-Vibe
Card 2: Scale Fast Â· Visual Consistency Â· Time Saver Â· Ready to Post
Card 3: Ray Tracing Â· Physical Shadows Â· Studio Quality Â· Sunlight Sync
Middle: flex-1 spacer.

Bottom of each card (mt-6):

Title h3: font-heading italic text-white text-3xl md:text-4xl tracking-[-1px] leading-none â€” "AI Scenery" / "Batch Production" / "Smart Lighting"
Body p (mt-3 text-sm text-white/90 font-body font-light leading-snug max-w-[32ch]):
"AI analyzes your product to create indistinguishable natural environments â€” from Icelandic cliffs to misty forests."
...
ArrowUpRight: 24Ã—24, M7 17L17 7 + M7 7h10v10, strokeWidth 2, round caps.
Play: 24Ã—24 filled polygon 6 4 20 12 6 20 6 4.
Notes
All text white; no green, no gradient backgrounds.
No CSS transitions on the videos â€” fades must be rAF-driven per the FadingVideo spec.
Videos are full-bleed with no dark overlay; contrast comes from the liquid-glass chrome.
Framer Motion dev warnings about list keys can be suppressed with a console.error filter wrapper â€” they're benign.
