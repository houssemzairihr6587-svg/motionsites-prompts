...
**AppleLogo** â€” inline SVG Apple mark, `viewBox="0 0 384 512"`, `fill="currentColor"`, default `w-4 h-4`. Path:
...
**LogoMark** â€” abstract 4-quadrant curve mark, `viewBox="0 0 256 256"`, default `w-8 h-8`, white fill. Path:
...
**AppleButton** â€” rounded-full white pill, Apple logo + "Download Aura" label + ChevronRight. Chevron translates `+1px` on group hover. Classes: `group inline-flex items-center justify-center gap-2 rounded-full bg-white text-black font-medium text-sm px-5 py-3 transition-all hover:bg-white/90 active:scale-[0.98]`. Accepts `label` and `full` props.

**SectionEyebrow** â€” `<span className="w-1.5 h-1.5 rounded-full bg-white" />` + label, optional tag pill with `px-2 py-0.5 rounded-full border border-white/10 text-white/50`.
...
- Line 2: "Revitalized" â€” apply `animate-shiny` and the `gradientStyle` inline.
...
## Section 3 â€” macOS menu bar strip
...
Title bar: three traffic lights `#ff5f57`, `#febc2e`, `#28c840` (each `w-3 h-3 rounded-full`); center label "Aura â€” Inbox" `text-xs text-white/50`.
...
- 6 messages with name, subject, preview, time, unread/active flags:
  - Linear â€” "Weekly product digest" â€” "Your team shipped 23 issues this week..." â€” 9:41 AM â€” unread + active
  - Sophia Chen â€” "Re: Q3 roadmap review" â€” "Thanks for sending the deck over. I had a few thoughts..." â€” 8:12 AM â€” unread
  - Figma â€” "Marcus commented on your file" â€” "Love the new direction on the landing hero." â€” Yesterday
  - Stripe â€” "Payout of $12,480.00 sent" â€” "Your payout is on its way to your bank..." â€” Yesterday
  - Vercel â€” "Deployment ready for aura-web" â€” "Preview is live at aura-web-g3f.vercel.app" â€” Mon
  - GitHub â€” "[aura/core] PR #482 approved" â€” "david-lim approved your pull request." â€” Mon
...
- Header: "Weekly product digest"; sender avatar gradient bubble `w-7 h-7 rounded-full bg-gradient-to-br from-[#00d2ff] to-[#0B2551]` with "L"; "Linear" + "to me Â· 9:41 AM"; "Work" pill.
- Body:
  ...
  - Paragraphs: "Hi team,", "Here is your weekly digest of everything happening across your projects. This was a strong week with significant progress on the Q3 roadmap.", "Twenty-three issues were closed, fourteen pull requests were merged, and two customer-facing features went out. The velocity trend continues to climb.", "Let me know if you would like a deeper breakdown by project or contributor.", "â€” The Linear team" (`text-white/50`).
  - Attachment pill with `Paperclip` icon: "digest-may-6.pdf".

## Section 5 â€” FeatureTriage

`max-w-6xl mx-auto px-6 py-20 md:py-28`, two-column grid `grid md:grid-cols-2 gap-10 md:gap-16 items-start`.

Left column motion (y 20 -> 0, 0.7s): `SectionEyebrow label="Triage" tag="AI-native"`, h2 `mt-5 text-3xl md:text-5xl font-semibold tracking-tight leading-[1.02]`: "Clear your inbox" <br/> "in a single pass.". Paragraph `mt-6 text-white/60 text-base leading-[1.6] max-w-md`: "Aura reads every message, understands intent, and routes the noise away from the signal. Focus on what moves your day forward â€” the rest handles itself." Chips row (`text-xs text-white/70 px-3 py-1.5 rounded-full border border-white/10 bg-white/[0.03]`): "Auto-categorize", "Snooze for later", "Silent newsletters", "One-tap unsubscribe".

Right column: `liquid-glass rounded-2xl p-5` card. Eyebrow text: "Today Â· 42 messages triaged". Four sub-cards (each `liquid-glass rounded-lg p-3`):
- Priority (4) `#ffffff` â€” items: "Sophia Chen â€” Q3 review", "David Lim â€” contract signoff"
- Follow-up (7) `#e5e5e5` â€” items: "Marcus â€” design review", "Figma â€” comment thread"
- Updates (18) `#a3a3a3` â€” items: "Vercel â€” deploy ready", "GitHub â€” PR #482 merged"
- Archived (13) `#525252` â€” items: "Stripe payout Â· Newsletter Â· Receipts"

## Section 6 â€” LogoCloud
...
- "Aura gave our leadership team four hours of their week back. It reads like email from the future." â€” Parker Wilf, Group Product Manager, MERCURY
- "The command palette alone has changed how I process messages. I can't imagine going back to a traditional client." â€” Andrew von Rosenbach, Senior Engineering Program Manager, COHERE
- "Triage that actually understands context. Our team stopped dreading Monday morning inboxes." â€” Mathies Christensen, Engineering Manager, LUNAR
...
- **Free** â€” "Free" â€” "For creators taking their first steps with Forma." â€” Up to 3 projects in the cloud / Image export up to 1080p / Basic editing tools / Free templates and icons / Access via web and mobile app.
- **Standard** â€” monthly "$9,99/m" yearly "$99,99/y" â€” "For freelancers and small teams who need more freedom and flexibility." â€” Up to 50 projects in the cloud / Export up to 4K / Advanced editing toolkit / Team collaboration (up to 5 members) / Access to premium template library.
- **Pro** (`c3-card-pro`) â€” monthly "$19,99/m" yearly "$199,99/y" â€” "For studios, agencies, and professional creators working with brands." â€” Unlimited projects / Export up to 8K + animations / AI-powered content generation tools / Unlimited team members / Brand customization.
...
- Paragraph `mt-6 text-white/60 max-w-md mx-auto text-sm leading-[1.6]`: "Join thousands of builders, founders, and operators who treat email like a tool â€” not an obligation."
...
Reproduce exactly â€” fonts, gradient stops, noise filters, copy strings, animation delays, and the CloudFront video URL `https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260508_064122_c4750c0e-7476-4b44-94a2-a85a65c63bf2.mp4`.
`````