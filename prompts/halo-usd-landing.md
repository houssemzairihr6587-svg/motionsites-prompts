...
`````nBuild a premium, fintech-style landing page for a stablecoin product called "Halo / USD Halo" using React + TypeScript + Vite + Tailwind CSS, with lucide-react for icons. No other UI libraries. Background color of the page is #F5F5F5.
...
Center (hidden below md): links Network Â· Ecosystem Â· Rewards Â· Help Â· News, gap-8, text-base text-gray-700 hover:text-black font-medium transition-colors duration-200.
Right: black pill button "Open Wallet" â€” bg-black text-white text-base font-medium px-7 py-2.5 rounded-full hover:bg-gray-800 transition-colors duration-200.
2. Hero Section
...
h1: "Your Wealth\nWorks" (with <br/>) â€” text-black text-5xl md:text-6xl font-medium leading-tight max-w-xl mb-4, inline letterSpacing: '-0.04em'.
p: "An automated, reward-powered digital dollar built for native passive earnings and effortless connection into DeFi." â€” text-black/70 text-base md:text-lg max-w-md mb-8 leading-relaxed, inline fontFamily: "'Inter', ui-sans-serif, system-ui, sans-serif".
...
Inject scoped <style> with keyframes marquee translating 0 â†’ -50%, applied to .marquee-track { display:flex; width:max-content; animation: marquee 22s linear infinite; }.
...
Stripe â€” Georgia serif, weight 700, letterSpacing -0.02em, fontSize 15px
Coinbase â€” Arial sans, weight 900, letterSpacing 0.08em, fontSize 13px, uppercase
Uniswap â€” Trebuchet MS, weight 600, letterSpacing 0.01em, fontSize 15px, italic
Aave â€” Courier New monospace, weight 700, letterSpacing 0.12em, fontSize 13px, uppercase
Compound â€” Palatino, Book Antiqua, weight 400, letterSpacing -0.01em, fontSize 16px
MakerDAO â€” Impact, Arial Narrow, weight 400, letterSpacing 0.04em, fontSize 14px
Chainlink â€” Verdana, weight 700, letterSpacing -0.03em, fontSize 13px
...
Left: h2 "Meet USD Halo." â€” text-black text-4xl md:text-5xl font-medium leading-tight mb-8, letterSpacing -0.03em. Below it, black pill "Discover it" button with white arrow circle (same pattern as "Join us" but text-base).
Right: paragraph "USD Halo is a reward-earning dollar coin that lets your savings grow while remaining tied to the U.S. dollar." â€” text-black/70 text-2xl md:text-3xl leading-relaxed.
Row 2 â€” 4-col card grid (grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4):
...
https://images.higgs.ai/?default=1&output=webp&url=https%3A%2F%2Fd8j0ntlcm91z4.cloudfront.net%2Fuser_38xzZboKViGWJOttwIXH07lWA1P%2Fhf_20260423_164207_f243351d-ed59-48ec-83a0-a5e996bdbe3c.png&w=1280&q=85
 ...
 backgroundSize: cover; backgroundPosition: center. Inside: p-7 min-h-80 flex flex-col justify-between. Title (top): "Savings that bloom" â€” text-black text-2xl font-medium leading-snug letterSpacing -0.02em. Body (bottom): "Gain steady returns as your dollar tokens are routed into top-performing DeFi strategies." â€” text-black/70 text-base max-w-xs.
Card 2: solid #2B2644, rounded-2xl, p-7, min-h-80, flex-col-justify-between. White heading "Always fluid,\nalways pegged." text-2xl font-medium, body "Keep fully dollar-anchored with on-demand access to funds â€” no lockups or waits." text-white/60 text-base.
...
Left col (1/4): text-black/70 text-base leading-relaxed â€” "Funded by premier partners\nand forward-thinking leaders."
...
Fundamental Labs â€” Times New Roman serif, 400, ls 0.02em, 14px
KUCOIN â€” Arial Black, 900, ls 0.08em, 16px
NGC â€” Impact, 700, ls 0.05em, 18px
NxGen â€” Georgia, 600, ls -0.02em, 17px
Matter Labs â€” Helvetica, 700, ls -0.01em, 15px
DEXTools â€” Verdana, 700, ls 0.06em, 14px, uppercase
NGRAVE â€” Courier New, 700, ls 0.18em, 14px
Polychain â€” Palatino, 500, ls 0.03em, 15px
...
Eyebrow: "USD Halo in Practice" â€” text-black/60 text-sm mb-2.
h2 "Use modes" â€” text-5xl md:text-6xl font-medium leading-none mb-6, ls -0.04em.
Paragraph: "USD Halo powers a wide range of modes for builders, companies and treasuries wanting safe and rewarding stablecoin integrations plus more" â€” text-black/60 text-base leading-relaxed max-w-sm.
...
h3 "Commerce" â€” text-4xl md:text-5xl font-medium leading-tight mb-5, ls -0.03em.
Paragraph: "Lift customer retention by offering USD Halo, a trusted dollar-backed stablecoin with strong yields, letting your patrons earn with zero effort on your platform." â€” text-black/70 text-base max-w-md mb-8.
...
Two CSS keyframe marquees (22s for hero brands, 30s for backers), both translating 0 â†’ -50% on a duplicated track for seamless looping.
