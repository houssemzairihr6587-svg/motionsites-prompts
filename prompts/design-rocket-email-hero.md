...
`````nPrompt: Recreate "Design Rocket Certificates" Email-Style Landing Page
...
Section 1 â€” Hero (video background)
...
"Design Rocket" â€” Instrument Serif, text-[28px] leading-[0.95] tracking-tight
"CERTIFICATES" â€” text-[13px] tracking-[0.22em] font-medium mt-1
Spacer mt-40, then "NOW AVAILABLE" â€” text-white text-[13px] tracking-[0.28em] font-semibold
...
<Divider />
Section 3 â€” "Transform how you lead with AI"
...
<Divider />
Section 4 â€” "Build your AI transformation roadmap"
...
Ready to lead AI
at work?
Subtext: text-[#1E1E1E] text-[18px] leading-[1.5] mb-8 px-4 â€” Enroll now and be the leader your team has been waiting for.
Centered <PrimaryButton label="Enroll Now" />
Footer
bg-[#080808] text-white pt-12 px-10 text-center border-t border-white/5
Wordmark link text-[30px] font-bold tracking-tight text-white hover:text-[#DCFF00] transition-colors â†’ "Design Rocket" (wrapped in pb-8 flex justify-center)
...
Social icon row flex justify-center gap-5 pb-5 â€” six circular buttons mapping [Facebook, Twitter, Instagram, Youtube, Linkedin, Music2] from lucide-react. Each:
...
Â©2026 Design Rocket, 660 4th Street #443, San Francisco, CA 94107 USA
