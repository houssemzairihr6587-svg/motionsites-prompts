...
Left: Logo (concentric circles icon â€” outer w-7 h-7 with border-2 border-foreground/60, inner w-3 h-3 with border border-foreground/60) + "Mindloop" bold text.
Center-left: Nav links ["Home", "How It Works", "Philosophy", "Use Cases"] separated by â€¢ dots. Links are text-muted-foreground hover:text-foreground.
...
No background â€” fully transparent, fixed top-0 z-50, padding px-8 md:px-28 py-4.
...
Heading: text-5xl md:text-7xl lg:text-8xl font-medium tracking-[-2px] â€” "Get Inspired with Us" where "Inspired" is font-serif italic font-normal.
Subtitle: text-lg in hsl(var(--hero-subtitle)) color â€” "Join our feed for meaningful updates, news around technology and a shared journey toward depth and direction."
...
Heading: text-5xl md:text-7xl lg:text-8xl â€” "Search has changed. Have you?" with "changed." in serif italic.
...
Paragraph 1 (text-2xl md:text-4xl lg:text-5xl font-medium tracking-[-1px]): "We're building a space where curiosity meets clarity â€” where readers find depth, writers find reach, and every newsletter becomes a conversation worth having." Words "curiosity", "meets", "clarity" are highlighted in --foreground, rest in --hero-subtitle.
Paragraph 2 (text-xl md:text-2xl lg:text-3xl font-medium mt-10): "A platform where content, community, and insight flow together â€” with less noise, less friction, and more meaning for everyone involved."
...
Heading: text-4xl md:text-6xl â€” "The platform for meaningful content" (serif italic on "meaningful").
...
4-column feature grid (md:grid-cols-4 gap-8): Curated Feed, Writer Tools, Community, Distribution â€” each with title (font-semibold text-base) and description (text-muted-foreground text-sm).
...
Left: "Â© 2026 Mindloop. All rights reserved." in text-muted-foreground text-sm.
