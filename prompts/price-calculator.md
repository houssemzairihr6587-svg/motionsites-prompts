...
`````nRecreate Project Estimation Calculator Section
...
Header: Centered. Small mono uppercase tracking-widest label "Try project estimation calculator" in text-muted-foreground. Below it, an h2: "Get premium website within your budget" â€” text-3xl md:text-4xl lg:text-5xl font-normal.
...
Service Type (radio buttons): h3 "What kind of service do you need?" â€” 3 options: "Only Design" (design), "Only Development" (development), "Design + Development" (both, default). Custom radio circles: w-5 h-5 rounded-full border-2, active = border-[#FF5656] with inner w-2 h-2 rounded-full bg-[#FF5656].
...
"I will need help with content" â†’ +$50/pages

"I want to optimize my website for SEO" â†’ +$50/pages Custom checkboxes: w-5 h-5 border-2 rounded, checked = border-[#FF5656] bg-[#FF5656] with white SVG checkmark.

Timeline (radio buttons): h3 "How fast do you need this?" â€” 3 options with prices:

"Within 7 Days" â†’ +$100/pages

"Within 14 Days" â†’ +$25/pages

"Regular Speed (Based on discussion)" â†’ no extra cost (default)
