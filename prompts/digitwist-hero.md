...
`````nCreate a dark mode hero section for an AI website builder with the following exact specifications:
...
- Color: white
- Animation: Motion fade up (opacity 0â†’1, y 20â†’0, duration 0.6s)
...
- Animation: Motion scale (opacity 0â†’1, scale 0.9â†’1, delay 0.2s, duration 0.6s)
...
- Max width: max-w-xl
- Animation: Motion fade (opacity 0â†’0.7, delay 0.4s, duration 0.6s)
...
- Animation: Motion fade up (opacity 0â†’1, y 20â†’0, delay 0.6s, duration 0.5s)
