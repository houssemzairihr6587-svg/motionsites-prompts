...
`````nCreate a responsive, full-screen hero section for a web application using React and Tailwind CSS.
...
Button 1: "Book a Free Demo" â€” Primary Purple (#7b39fc), rounded 10px, Cabin Medium 16px, White.
Button 2: "Get Started Now" â€” Dark Purple (#2b2344), rounded 10px, Cabin Medium 16px, Off-white (#f6f7f9).
