...
`````nBuild a full-viewport cinematic hero section for a travel brand called "Wanderful" using React + TypeScript + Vite + Tailwind CSS. Use GSAP for animation and `lucide-react` for icons.
...
Fade-in on mount: `opacity 0 â†’ 100` and `translate-y-6 â†’ 0` with `transition-all duration-1000`.
...
1. Paragraph, `max-w-[620px] text-[15px] leading-relaxed` centered:
   - White: "Our smart itineraries shape around you â€” your rhythm, your vibe, your hunger for adventure."
