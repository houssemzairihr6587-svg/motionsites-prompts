...
`````nBuild a React functional component using Tailwind CSS, `motion/react` for animations, and `lucide-react` for icons.
...
- **Footer Content (Bottom Bar):**
  ...
  - Text: "Â© 2026 HAUL! All Rights Reserved" (text-sm, gray-500, medium).
